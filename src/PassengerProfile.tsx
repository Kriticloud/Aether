...
export default function PassengerProfile() {
  ...
  const [activeTab, setActiveTab] = useState<"Overview" | "Security Audit">(
    "Overview",
  );
    ...
    <div className="p-8 pb-32 max-w-6xl mx-auto">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="flex space-x-2 border-b border-aether-glass-border pb-px mb-6">
            <button
              onClick={() => setActiveTab("Overview")}
              className={`px-4 py-2 text-sm font-medium tracking-widest uppercase transition-colors ${activeTab === "Overview" ? "text-aether-gold border-b-2 border-aether-gold" : "text-aether-steel hover:text-white"}`}
            >
              Overview
            </button>
            <button
              onClick={() => setActiveTab("Security Audit")}
              className={`px-4 py-2 text-sm font-medium tracking-widest uppercase transition-colors ${activeTab === "Security Audit" ? "text-aether-gold border-b-2 border-aether-gold" : "text-aether-steel hover:text-white"}`}
            >
              Security Audit
            </button>
          </div>
            ...
            <>
              ...
              >
                <h3 className="text-xl font-serif mb-6 flex items-center gap-2">
                  <User className="w-5 h-5 text-aether-gold" /> Flight
                  Preferences
                </h3>
